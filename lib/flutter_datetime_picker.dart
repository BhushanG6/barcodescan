  ...
  Widget _renderPickerView(DatePickerTheme theme) {
    ...
    if (widget.route.showTitleActions) {
     ...
     // mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        ...
        //   child: CupertinoButton(
        //     pressedOpacity: 0.3,
        //     padding: EdgeInsets.only( right:getProportionateScreenWidth(18),top: getProportionateScreenHeight(0)),
        //     child: Text(
        //           'Cancel',
  ...
  Widget _renderTitleActionsView(DatePickerTheme theme) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.headerColor ?? theme.backgroundColor ?? Colors.white,borderRadius: BorderRadius.all(Radius.circular(34))
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          Container(
            ...
            child: CupertinoButton(
              ...
              child: Text(
                '$cancel',
                 style: TextStyle(color: Colors.black,fontSize: 18,fontFamily: 'SF Pro Display'),
              ),
              onPressed: () {
                Navigator.pop(context);
                if (widget.route.onCancel != null) {
          ...
          Container(
            ...
            child: CupertinoButton(
              ...
              child: Text(
                '$done',
                style: TextStyle(color: Colors.blue,fontSize: 18,fontFamily: 'SF Pro Display'),
              ),
              onPressed: () {
                Navigator.pop(context, widget.pickerModel.finalTime());
                if (widget.route.onConfirm != null) {
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    double maxHeight = getProportionateScreenHeight(400);
    if (showTitleActions) {
    ...
    return BoxConstraints(
      ...
      minWidth: getProportionateScreenWidth(350),
      maxWidth:getProportionateScreenWidth(375),//getProportionateScreenWidth(350),
      minHeight: 0.0,
      maxHeight: getProportionateScreenHeight(320), //+ bottomPadding,
    );
  }

  @override
  Offset getPositionForChild(Size size, Size childSize) {
    final height = getProportionateScreenHeight(490);
    return Offset(getProportionateScreenWidth(0), height);
  }
